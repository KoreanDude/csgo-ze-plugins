...
#define VERSION "3.4 Franug edition (Fixed by someone)"
...
public Plugin:myinfo =
{
	...
	author = "Greyscale, Richard Helgeby, Franc1sco, Someone",
...
public OnMapStart()
{
	...
	PrecacheSound("*/melong/zombie/zo_attack1.wav");
	PrecacheSound("*/melong/zombie/zombie_alert1.wav");
	PrecacheSound("*/melong/zombie/zombie_alert2.wav");
	PrecacheSound("*/melong/zombie/zombie_alert3.wav");
	PrecacheSound("*/melong/zombie/pz_alert1.wav");
	PrecacheSound("*/melong/zombie/pz_call1.wav");
	PrecacheSound("*/melong/zombie/fz_alert_far1.wav");
	PrecacheSound("*/melong/zombie/fz_frenzy1.wav");
	PrecacheSound("*/melong/zombie/playground_memory.wav");
}
